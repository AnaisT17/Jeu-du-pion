...
pion.src = 'pion1.png';
pion.style.cssText="width:100px; height:100px";
// Créer la cage avec un élément TABLE.
let cage = document.createElement('table');
cage.style.cssText = "border: 3px solid; border-collapse: collapse";
// Boucle des rangées.
for (let x = 0; x < 5; x++) {
	// Créer chaque rangée.
	...
	for (let y = 0; y < 5; y++) {
		...
		td.style.cssText = "border: 2px solid; width: 100px; height: 100px; font-size: 0";
	}
}
